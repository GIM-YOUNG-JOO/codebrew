...
public class Pager {
<<<<<<< HEAD
   private int totalRows;      //페이징 대상이 되는 전체 행수 ex)총 게시글 10000개
   private int totalPageNo;   //전체 페이지 수 ex)10개씩 글을 보여준다고 할 때 1000개
   private int totalGroupNo;   //전체 그룹 수 ex)페이지가 1000개라고 할 때 100개(1~10, 11~20, ...)
   private int startPageNo;   //그룹의 시작 페이지 번호
   private int endPageNo;      //그룹의 끝 페이지 번호
   private int pageNo;         //현재 페이지 번호
   private int pagesPerGroup;   //그룹당 페이지 수 ex)1~10의 경우 10개
