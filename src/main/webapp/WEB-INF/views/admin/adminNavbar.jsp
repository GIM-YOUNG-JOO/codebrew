...
<div class="d-flex col flex-column flex-shrink-0 p-3 text-white bg-dark rounded-start-4"
	...
	<a href="${pageContext.request.contextPath}" class="d-flex justify-content-center align-items-center text-white text-decoration-none"> <span class="fs-4">Admin Page</span>
	</a>
	<hr>
