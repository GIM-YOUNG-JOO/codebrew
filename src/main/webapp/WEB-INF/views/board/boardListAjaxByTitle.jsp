			...
			<div id="boardContainer">
				...
				<table class="table text-center">
				    <tr>
				        <td colspan="4">
				            <div>
				                <a class="btn btn-sm" href="javascript:searchTitle(1)">처음</a>
								<c:if test="${pager.groupNo>1}">
			                     	<a class="btn btn-sm" href="javascript:searchTitle(${pager.startPageNo-1})">이전</a>
			                	</c:if>
			                	
				                <c:forEach var="i" begin="${pager.startPageNo}" end="${pager.endPageNo}">
				                    <c:if test="${pager.pageNo != i}">
				                        <a class="btn btn-sm" href="javascript:searchTitle(${i})">${i}</a>
				                    </c:if>
